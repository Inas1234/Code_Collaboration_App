    ...
    <Container maxW="container.xxl" centerContent>
      <VStack spacing={50} mt={10} p={5} align="stretch">
        ...
        <Text fontSize="md" textAlign="center" marginTop={50}>
          Welcome to CodeCrew!
          <br />
          Unlock the power of collaboration with our advanced, feature-rich
          ...
          <br />
          <br />
          Create or Join Projects: Enter a project code and start collaborating
          in seconds.
          <br />
          <br />
          ...
          <br />
          <br />
          Connect & Code: Team up with developers worldwide to bring your ideas
          to life.
          <br />
          <br />
